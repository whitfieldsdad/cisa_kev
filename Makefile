...
data: init
	poetry run kev -i data/known_exploited_vulnerabilities.json -o data/known_exploited_vulnerabilities_processed.json
	...
	poetry run kev -i data/known_exploited_vulnerabilities.json -f jsonl -o data/known_exploited_vulnerabilities_processed.jsonl
